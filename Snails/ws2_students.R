...
snaildata <- data.frame(read.csv("snaildata2023.csv"))
...
# We can see here that our minimum DO consumed is a negative value (-205.726!). This is not realistic,
...
# when inspecting our data frame, we can see some problematic values in the 15, 18, 27, and 30 degree treatments.
